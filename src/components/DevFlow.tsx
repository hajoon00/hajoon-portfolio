...
function DevFlow() {
  ...
  const conceptualizationRef = useRef(null);
  const initialDesignRef = useRef(null);
  const hiFiPrototypeRef = useRef(null);
  const frontendProgrammingRef = useRef(null);
  const designAdjustmentRef = useRef(null);
  const aiIntegrationRef = useRef(null);
  const futureEnhancementRef = useRef(null);
  const finalReflectionRef = useRef(null);
